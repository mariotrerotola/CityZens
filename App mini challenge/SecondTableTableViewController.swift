...
class SecondTableTableViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    // MARK: - Table view data source
     ...
     func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
      ...
      func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let currentData = marketData[indexPath.row]
        
        cell.textLabel?.text = currentData
        
        cell.detailTextLabel?.text = marketAddress[indexPath.row]
